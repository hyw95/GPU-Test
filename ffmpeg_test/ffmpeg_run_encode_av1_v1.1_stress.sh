...
../ffmpeg/ffmpeg -y  -r 30 -i ${VIDEO} \
                                     -filter_complex "[0:v]hwupload_cuda,split=4[o0][o1][o2][o3]" \
                                     -map "[o0]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 3M  -bufsize 3M/30  -g 999999 -vsync 0 ${VIDEO1}_3M.ivf \
                                     -map "[o1]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 5M  -bufsize 5M/30  -g 999999 -vsync 0 ${VIDEO1}_5M.ivf \
                                     -map "[o2]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 8M  -bufsize 8M/30  -g 999999 -vsync 0 ${VIDEO1}_8M.ivf \
                                     -map "[o3]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 10M -bufsize 10M/30 -g 999999 -vsync 0 ${VIDEO1}_10M.ivf >> ${VIDEO}_AV1_Process2.log 2>&1 &
...
../ffmpeg/ffmpeg -y  -r 30 -i ${VIDEO} \
                                     ...
                                     -map "[o1]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 5M  -bufsize 5M/30  -g 999999 -vsync 0 ${VIDEO1}_5M.ivf \
                                     -map "[o2]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 8M  -bufsize 8M/30  -g 999999 -vsync 0 ${VIDEO1}_8M.ivf \
                                     -map "[o3]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 10M -bufsize 10M/30 -g 999999 -vsync 0 ${VIDEO1}_10M.ivf >> ${VIDEO}_AV1_Process4.log 2>&1 &
...
../ffmpeg/ffmpeg -y  -r 30 -i ${VIDEO} \
                                     ...
                                     -map "[o1]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 5M  -bufsize 5M/30  -g 999999 -vsync 0 ${VIDEO1}_5M.ivf \
                                     -map "[o2]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 8M  -bufsize 8M/30  -g 999999 -vsync 0 ${VIDEO1}_8M.ivf \
                                     -map "[o3]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 10M -bufsize 10M/30 -g 999999 -vsync 0 ${VIDEO1}_10M.ivf >> ${VIDEO}_AV1_Process6.log 2>&1 &
...
../ffmpeg/ffmpeg -y  -r 30 -i ${VIDEO} \
                                     ...
                                     -map "[o1]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 5M  -bufsize 5M/30  -g 999999 -vsync 0 ${VIDEO1}_5M.ivf \
                                     -map "[o2]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 8M  -bufsize 8M/30  -g 999999 -vsync 0 ${VIDEO1}_8M.ivf \
                                     -map "[o3]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 10M -bufsize 10M/30 -g 999999 -vsync 0 ${VIDEO1}_10M.ivf >> ${VIDEO}_AV1_Process8.log 2>&1 &
...
../ffmpeg/ffmpeg -y  -r 30 -i ${VIDEO} \
                                     ...
                                     -map "[o1]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 5M  -bufsize 5M/30  -g 999999 -vsync 0 ${VIDEO1}_5M.ivf \
                                     -map "[o2]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 8M  -bufsize 8M/30  -g 999999 -vsync 0 ${VIDEO1}_8M.ivf \
                                     -map "[o3]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 10M -bufsize 10M/30 -g 999999 -vsync 0 ${VIDEO1}_10M.ivf >> ${VIDEO}_AV1_Process10.log 2>&1 &
...
../ffmpeg/ffmpeg -y  -r 30 -i ${VIDEO} \
                                     ...
                                     -map "[o1]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 5M  -bufsize 5M/30  -g 999999 -vsync 0 ${VIDEO1}_5M.ivf \
                                     -map "[o2]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 8M  -bufsize 8M/30  -g 999999 -vsync 0 ${VIDEO1}_8M.ivf \
                                     -map "[o3]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 10M -bufsize 10M/30 -g 999999 -vsync 0 ${VIDEO1}_10M.ivf >> ${VIDEO}_AV1_Process12.log 2>&1 &
...
../ffmpeg/ffmpeg -y  -r 30 -i ${VIDEO} \
                                     ...
                                     -map "[o1]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 5M  -bufsize 5M/30  -g 999999 -vsync 0 ${VIDEO1}_5M.ivf \
                                     -map "[o2]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 8M  -bufsize 8M/30  -g 999999 -vsync 0 ${VIDEO1}_8M.ivf \
                                     -map "[o3]" -c:v av1_nvenc -preset p1 -rc cbr -tune ll -multipass 0 -b:v 10M -bufsize 10M/30 -g 999999 -vsync 0 ${VIDEO1}_10M.ivf >> ${VIDEO}_AV1_Process14.log 2>&1
done
